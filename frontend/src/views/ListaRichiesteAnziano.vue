<template>
  <div class="col-md-12">
    <div class="card card-container">
      ...
      <p>
        Qui puoi vedere tutte le <strong>richieste d'aiuto</strong> che hai fatto nel tempo, così non c'è bisogno che
        ricordi tutto!<br />
        Cliccando sulle <strong>icone</strong> in fondo ad ogni riga puoi <strong>modificare</strong>,
        <strong>eliminare</strong> o <strong>visualizzare i dettagli</strong> di ogni richiesta... provare per credere!
      </p>
      <v-data-table
